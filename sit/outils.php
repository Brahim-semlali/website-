...
<div class="user-profile">
   ...
   ?>
   <div class="flex">
   <a href="outils.php" class="refresh-btn">Refresh</a> <!-- Bouton de rafraîchissement -->
...
<div class="products">
   ...
   <form method="get" action="">
       <input type="text" name="search_query" placeholder="Rechercher des outils...">
   ...
   <?php
      ...
      if(isset($_GET['search_query'])) {
          ...
          $select_product = mysqli_query($con, "SELECT * FROM `outils` WHERE name LIKE '%$search_query%'") or die('query failed');
   ...
   <?php
          ...
          $select_product = mysqli_query($con, "SELECT * FROM `outils`") or die('query failed');
          if(mysqli_num_rows($select_product) > 0){
              while($fetch_product = mysqli_fetch_assoc($select_product)){
   ?>
      <form method="post" class="box" action="">
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="outils.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('remove item from cart?');">remove</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="outils.php?delete_all" onclick="return confirm('delete all from cart?');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">delete all</a></td>
      </tr>
   </tbody>
   </table>
