...
<html lang="en" class="no-js">
	<head>
		...
		<title>Image Grid Pan Effect | Demo 1 | Codrops</title>
		...
		<main>
			...
			<div class="content">
				...
				<h2 class="content__title no-select">
					<span>The payment process </span>
                   
					<span class="content__title-sub">was completed successfully</span>
                     <span><a href="../../store.php" class="content__title no-select">   -Back- </a></span>
				</h2>
			</div>
		</main>
