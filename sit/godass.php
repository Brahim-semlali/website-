...
// Valeur temporaire pour test (à remplacer par une vraie authentification plus tard)
$user_id = 1; // ou une autre valeur qui existe dans votre table users

// Commenter ou supprimer cette vérification temporairement
/*
if(!isset($user_id)){
...
<head>
   ...
   <style> <?php include("godass.css"); ?></style>
...
<div class="user-profile">
   ...
   <div class="flex">
    ...
    <a href="godass.php" class="refresh-btn">Refresh</a> <!-- Bouton de rafraîchissement -->
...
<div class="products">
   ...
   <form method="get" action="">
       <input type="text" name="search_query" placeholder="Rechercher des godasses...">
   ...
   <?php
      ...
      if(isset($_GET['search_query'])) {
          ...
          $select_product = mysqli_query($con, "SELECT * FROM `products` WHERE name LIKE '%$search_query%'") or die('query failed');
